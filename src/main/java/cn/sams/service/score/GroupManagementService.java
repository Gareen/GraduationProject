...
public class GroupManagementService {
    ...
    public ReturnObj saveorupdate(HttpServletRequest req) {
        ...
        // 分组编号组合
        String group_code = req.getParameter("group_code");
        // 分组编号
        ...
        // 分组编码
        String enCodeGroupInfo = req.getParameter("group_code");

        System.out.println(enCodeGroupInfo);

        if ("add".equals(jud)) {
            String group_id = encodeGroupid(req);
     ...
     * @return
     */
    private String encodeGroupid(HttpServletRequest req) {
