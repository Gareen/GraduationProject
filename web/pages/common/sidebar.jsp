...
<%--<script src="${ctx}/js/common/test.js"></script>--%>
  <style>
    #view-content-left{  width:50px; }
    #view-content-left-sub{  left: 50px;  }
    #view-content-main{  left: 230px;  }
  </style>
  ...
  <ul class="sidebar-nav nav1" id="sideNav1">
      ...
      <li class="nav-item">
          <a href="/sams/score/groupManagement/toIndex.do" id="socreMgr" p_id="200">
            <div class="iconTooltip nav-icon "   data-toggle="tooltip" data-placement="right" data-title="<div class='nav-icon-tooltip'>成绩管理</div>" >
      ...
      <li class="nav-item">
          <a href="/sams/system/termManagement/toIndex.do" id="systemMgr" p_id="100">
              <div class="iconTooltip nav-icon "   data-toggle="tooltip" data-placement="right" data-title="<div class='nav-icon-tooltip'>后台资源管理</div>" >
                  <m class="fa fa-cog"></m>
              </div>
