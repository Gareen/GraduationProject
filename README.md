...
### 3.学期管理<br>
管理系统中的学期, 支持新增, 修改, 删除学期的信息<br><br>
### 4.学生管理<br>
展示学生的信息, 支持批量导入学生信息, 按班级删除学生信息, 支持手动新增, 修改, 删除学生信息<br><br>
### 5.课程管理<br>
...
2. 上课信息管理  
支持对上课信息进行新增, 修改, 删除操作.<br><br>
### 6.班级管理<br>
展示班级的信息, 支持对班级信息进行新增, 修改, 删除操作<br><br>
